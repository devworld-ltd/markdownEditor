...
MarkdownEditor 프로젝트의 전체 문서 목록. 최종 갱신: 2026-09-22 (v2.8.3 기준).
...
| 알고 싶은 것 | 문서 |
|--------------|------|
| 이 프로젝트를 **넘겨받았다** | [인수인계 문서](./handover.md) |
...
| [기능 개발 현황](./features/feature-status.md) | F-01~F-91 구현/부분/미구현/제거 분류, 권장 개발 순서 |
...
| [테스트 실행 결과](./testing/test-results.md) | 스위트 실행 결과, 발견·수정한 버그. ⚠️ 본문 건수는 v2.6.0 시점(1092/518) — 실측값은 [인수인계 문서 §1](./handover.md#1-한-장-요약) |
...
| 문서 | 내용 |
|------|------|
| [인수인계 문서](./handover.md) | 현재 상태 스냅샷, 30분 온보딩, 브랜치·릴리스·배포 절차, 자격증명 위치, 남은 과제, 자동 테스트가 못 지키는 3곳 |
