...
| `markdownExtensions.ts` | 97.61% | 87.5% | 100% | **100%** | marked 확장 |
| `scrollAnchors.ts` | 97.72% | 97.14% | 100% | **100%** | 순수 모듈 |
| `sourceLines.ts` | 95.65% | 87.5% | 100% | **94.44%** | 순수 모듈 |
| `mermaidView.ts` | 100% | 86.36% | 100% | **100%** | 주입형 리프 (지연 로드 경계) |
