...
| `tests/e2e/overlaya11y.spec.ts` | 9 | F-59 재검증 |
...
| `src/style.css` (`#preview code`·`pre` 코드 표면) | 같은 규칙이 네 곳에 있다 — `.manual-body pre code` · `htmlExport.ts` · `@media print` · `tests/e2e/codeblock.spec.ts`(#180) |
